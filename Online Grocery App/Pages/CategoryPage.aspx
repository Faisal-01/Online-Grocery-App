<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="CategoryPage.aspx.cs" Inherits="Online_Grocery_App.Pages.CategoryPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main>
        <div class="space"></div>
        <section>
            <h1 class="categoryName" id="categoryName" runat="server">Rice</h1>
            <hr>
